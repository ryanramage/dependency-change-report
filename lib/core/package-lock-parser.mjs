  ...
  if (lockData.lockfileVersion >= 2 && lockData.packages) {
    ...
    for (const [path, info] of Object.entries(lockData.packages)) {
      ...
      if (pathParts.length > 1) {
        ...
        const parentName = parentPath.replace(/^node_modules\//, '') || 'ROOT';
    ...
    // Version 1 format
    buildGraphFromDependencies(lockData.dependencies, graph, 'ROOT');
  }
 ...
 * @param {string} parentName - Name of parent package
 */
